...
public class financialModel implements Serializable {
    ...
    public financialModel(String symbol, String date, String period,
                          double revenueGrowth, double grossProfitGrowth, double ebitgrowth, double operatingIncomeGrowth,
